...
(function() {
    ...
    createButton(steamDBSearchLink, "Online Fix", "Искать на Online Fix(EN)", "https://i.imgur.com/WAXRAUw.png");

    const site1SearchLink = `https://www.skidrowreloaded.com/?s=${formattedGameName}&x=0&y=0`;
    createButton(site1SearchLink, "Skidrow", "Искать на Skidrow(EN)", "https://i.imgur.com/sfzB2DE.png");

    const site2SearchLink = `https://fitgirl-repacks.site/?s=${formattedGameName}`;
    createButton(site2SearchLink, "FitGirl", "Искать на FitGirl(EN)", "https://i.imgur.com/GOFbweI.png");

    const newSiteSearchLink = `https://steamrip.com/?s=${formattedGameName}`;
    createButton(newSiteSearchLink, "SteamRIP", "Искать на SteamRIP(EN)", "https://i.imgur.com/tmvOT86.png");

    const new1SiteSearchLink = `https://dodi-repacks.site/?s=${formattedGameName}`;
    createButton(new1SiteSearchLink, "Dodi", "Искать на Dodi(EN)", "https://i.imgur.com/g71t1Ge.png");

    const new2SiteSearchLink = `https://gload.to/?s=${formattedGameName}`;
    createButton(new2SiteSearchLink, "Gload", "Искать на Gload(EN)", "https://gload.to/logo.png");

    const new3SiteSearchLink = `https://rutracker.org/forum/tracker.php?nm=${formattedGameName}`;
    createButton(new3SiteSearchLink, "Rutracker", "Искать на Rutracker(Ru)", "https://i.imgur.com/BEigadR.png");

    const new4SiteSearchLink = `https://nnmclub.to/forum/tracker.php?nm=${formattedGameName}`;
    createButton(new4SiteSearchLink, "NoNameClub", "Искать на NoName Club(Ru)", "https://i.imgur.com/4jhiiXy.png");
})();
